! function() {
  ...
  function e() {
    ...
    function n(t, e, a) {
      ...
      return t.toLowerCase() in r && (i = r[t.toLowerCase()] + i), a && (i = i + ' <span style="font-size:17px">' + t.toUpperCase() + "</span>"), i
    }
    ...
    function o(t, e, a, i, r, o, d, s) {
      ...
      if (1 == c && (l = 100), 2 == c && (l = 49.8), 3 == c && (l = 33), t) {
        ...
        p = '                    <div style="text-align:center;float:left;width:' + l + "%;font-size:17px;padding:12px 0;border-right:" + borderWidth + 'px solid #E4E6EB;line-height:1.25em;">                        RANK                        <br><br>                        <span style="font-size: 19px; ">' + o + "</span>                    </div>"
      }
      if (a) {
        borderWidth = 0, e && (borderWidth = 1);
        u = '                    <div style="text-align:center;float:left;width:' + l + "%;font-size:17px;padding:12px 0 16px 0;border-right:" + borderWidth + 'px solid #E4E6EB;line-height:1.25em;">                        MARKET CAP                        <br><br>                        <span style="font-size: 17px; ">' + n(r, d, i) + "</span>                    </div>"
      }
      if (e) h = '                    <div style="text-align:center;float:left;width:' + l + '%;font-size:17px;padding:12px 0 16px 0;line-height:1.25em;">                        VOLUME (24H)                        <br><br>                        <span style="font-size: 17px; ">' + n(r, s, i) + "</span>                    </div>";
    ...
    function d(a, i, r, n, d, s, c, l, p, u, h, f, m, v, g, x, y) {
      var b = "#093";
      p < 0 && (b = "#d14836"), valTickerHTML = m ? "(" + r + ")" : "", valPrice = s ? e(s, n) : "?", valPercentHTML = p ? '<span style="color:' + b + '">(' + p + "%)" : "", valMarketCap = u ? t(u, 2) : "?", valVolume = h ? t(h, 2) : "?", c ? (mainLineHeight = 25, valPriceSecondary = l ? e(l, c) : "?", secondaryHTML = '<br><span style="font-size: 14px; color:gray">' + valPriceSecondary + " " + c + " </span>") : (mainLineHeight = 30, secondaryHTML = "");
      var w = "utm_medium=widget&utm_campaign=cmcwidget&utm_source=" + location.hostname + "&utm_content=" + a,
        k = '<div style="border:2px solid #E4E6EB;border-radius: 10px;font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif;min-width:295px;">    <div>        <div style="float:right;width:67%;border: 0px solid #000;text-align:left;padding:5px 0px;line-height:' + mainLineHeight + 'px;">            <span style="font-size: 24px;"><a href="http://coinmarketcap.com/currencies/' + a + "/?" + w + '" target="_blank">' + i + " " + valTickerHTML + '</a></span> <br>            <span style="font-size: 19px;">' + valPrice + " " + n + " " + valPercentHTML + "</span></span>            " + secondaryHTML + '        </div>        <div style="text-align:center;padding:5px 0px;width:33%;"><img src="https://files.coinmarketcap.com/static/img/coins/64x64/' + a + '.png"></div>    </div>';
